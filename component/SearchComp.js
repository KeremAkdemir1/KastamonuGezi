import { View, TextInput, StyleSheet, Dimensions, FlatList, Text, Image, Pressable, TouchableOpacity, ScrollView,ActivityIndicator,Linking, Platform } from 'react-native'
            ...
            <View style={styles.container}>
              ...
              <View style={styles.tourCard}>
                  ...
                  <Image
                    style={styles.photo}
                    resizeMode="cover"
                    source={{ uri:"https://kastamonutravelguide.com.tr/" + item.path}}
                  />
